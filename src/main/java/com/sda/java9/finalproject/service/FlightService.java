...
public class FlightService {
    ...
    public List<FlightDTO> findFilteredFlights(String departureAirportId, String arrivalAirportId, String departureDate) {
        return flightDAO.getResultFromNativeQuery(departureAirportId, arrivalAirportId, departureDate)
                .stream().filter(flightDTO -> flightDTO.getCapacity() > flightDTO.getPassengers().size())
